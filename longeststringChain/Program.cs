...
namespace longeststringChain
{
    class Program
    {
        ...
        public static List<string> longeststringChain(List<string> strings)
        {
            ...
            foreach (string str in sortedstrings) { findLongeststringChain(str, stringChains); }
        ...
        public static string getSmallerstring(string str, int index) { return str.Substring(0, index) + str.Substring(index + 1); }
    ...
    {
        public string nextstring; public int maxChainLength;
        public stringChain(string nextstring, int maxChainLength) { this.nextstring = nextstring; this.maxChainLength = maxChainLength; }
    }
}
