...
namespace BalancedBinaryTreesAlgorithms.Tests
{
    [TestClass]
    public class EnumerationTests
    {
        ...
        public void LeftRotation_Basic()
        {
            ...
            tree.PreOrderTraversal(item => Assert.Equals(expected[index++], item));
        }
        ...
        public void Add_And_Remove_1k_Unique_Items()
        {
            ...
            while (items.Count < 1000)
            {
                ...
                if (!items.Contains(next))
                {
                    ...
                    Assert.Equals(items.Count, tree.Count);
                }
            }
        ...
        public void Rotation_Complexish()
        {
            ...
            tree.PreOrderTraversal(item => Assert.Equals(expected[index++], item));
            Assert.Equals(index, expected.Length);
        ...
        public void InOrder_Delegate()
        {
            ...
            tree.InOrderTraversal(item => Assert.Equals(expected[index++], item));
        }
    }
}
